...
const ACCOUNT_SID = 'cdc1aabbf2d445108cc13271eexxxxxx';             // 开发者ACCOUNT_SID，请登录sms.miaodiyun.com 获取
const AUTH_TOKEN = '5ecbeaa30b6c477cb77c2bedb5xxxxxx';              // 开发者AUTH_TOKEN，请登录sms.miaodiyun.com 获取
const HOST = 'https://openapi.miaodiyun.com/distributor';           // 接口域名
const SEND_SMS_URI = '/sendSMS';                                    // 普通短信发送URL
const to = '186xxxxxxxx';                                           // 发送手机号，多个手机号，用英文逗号隔开
